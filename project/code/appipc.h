...
typedef struct
{
    ...
    uint8 vision_detect_mode;  // 0 空闲，1 单边桥与颠簸路段，2 跳跃
...
// 初始化核心0状态接收端
// 使用场景：核心1调用，用于接收核心0发送过来的车速、视觉工作模式和 BAB 子状态。
