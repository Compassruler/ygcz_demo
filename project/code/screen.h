...
// 屏幕基础信息
// TFT180 横屏分辨率为 160x128
// 6x8 字体：单个 ASCII 字符宽 6 像素、高 8 像素
// 8x16 字体：单个 ASCII 字符宽 8 像素、高 16 像素
...
// 8x16 字体时
#define SCREEN_DATA_MAX_COUNT_8x16       6          // 最大数据种类显示数量
#define SCREEN_NAME_WIDTH_8x16          10          // 参数名称部分最大字符数
#define SCREEN_VALUE_WIDTH_8x16         10          // 参数数据部分最大字符数
...
// 6x8 字体最多显示 12 行，名称 10 字符，数据 16 字符
// 8x16 字体最多显示 6 行，名称 10 字符，数据 10 字符
// 设置字体后会自动重置数据表绘制状态
 ...
 *              - TFT180_8X16_FONT ：最多显示 SCREEN_DATA_MAX_COUNT_8x16 行，即 6 行。
 ...
 *          
 *         screen_show_data_table(imu_table, 8);
 * 
 *         system_delay_ms(100);
 *     }
 * }
